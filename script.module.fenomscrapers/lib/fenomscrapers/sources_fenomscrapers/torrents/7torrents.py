...
class source:
	...
	def __init__(self):
		self.language = ['en']
		self.base_link = 'https://www.7torrents.cc' # 7torr.com is a mirror of btscene, do not use
	...
	def get_sources(self, url):
		...
		for row in rows:
			try:
				...
				self.sources_append({'provider': '7torrents', 'source': 'torrent', 'seeders': seeders, 'hash': hash, 'name': name, 'name_info': name_info, 'quality': quality,
